...
from src.ai.api_client import get_openai_client, get_anthropic_client
...
def store_performance(user_id: int, model: str, latency: float, tokens_in: int, tokens_out: int, campaign_id: Optional[int] = None) -> None:
    """Alias pour rétrocompatibilité avec les tests."""
