...
class CampaignManager:
    ...
    @staticmethod
    def create_campaign(
        user_id: int, name: str, themes: List[str], language: str, ai_model: str = "GPT-4o", gm_portrait: Optional[str] = None
    ) -> int:
...
class MessageManager:
    ...
    @staticmethod
    def store_message(
        user_id: int, role: str, content: str, campaign_id: Optional[int] = None, character_id: Optional[int] = None
    ) -> int:
...
class PerformanceManager:
    ...
    @staticmethod
    def get_performance_stats(user_id: int, days: int = 7) -> Dict[str, Any]:
        ...
        with get_optimized_connection() as conn:
            ...
            stats = {"by_model": {}, "total_requests": 0, "total_cost": 0.0}
