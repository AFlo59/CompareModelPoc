...
class TestPerformanceAnalytics:
    ...
    def test_calculate_cost_gpt4(self):
        ...
        row = pd.Series({"model": "GPT-4", "tokens_in": 1000, "tokens_out": 500})
    ...
    def test_calculate_cost_claude(self):
        ...
        row = pd.Series({"model": "Claude 3.5 Sonnet", "tokens_in": 2000, "tokens_out": 800})
    ...
    def test_calculate_cost_deepseek(self):
        ...
        row = pd.Series({"model": "DeepSeek", "tokens_in": 5000, "tokens_out": 1500})
    ...
    def test_calculate_cost_unknown_model(self):
        ...
        row = pd.Series({"model": "Unknown Model", "tokens_in": 1000, "tokens_out": 500})
...
class TestSystemMonitoring:
    ...
    def test_get_system_info(self):
        ...
        with patch("platform.system") as mock_system, patch("platform.release") as mock_release, patch(
            "platform.processor"
        ) as mock_processor:
    ...
    def test_show_system_monitoring(self, mock_tabs, mock_title):
        ...
        with patch("src.analytics.system_monitoring.get_system_info") as mock_sys_info, patch(
            "src.analytics.system_monitoring.get_cpu_stats"
        ) as mock_cpu, patch("src.analytics.system_monitoring.get_memory_stats") as mock_mem, patch(
            "src.analytics.system_monitoring.get_disk_stats"
        ) as mock_disk, patch(
            "streamlit.metric"
        ), patch(
            ...
            mock_cpu.return_value = {
                "cpu_usage_total": 45.2,
                "cpu_usage_per_core": [20, 30, 40],
