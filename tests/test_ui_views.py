...
class TestAuthPage:
    ...
    def test_show_auth_page_login_success(self, mock_login, mock_radio, mock_columns, mock_markdown):
        ...
        with patch("streamlit.session_state", mock_session_state), patch("streamlit.success") as mock_success, patch(
            "streamlit.rerun"
        ) as mock_rerun, patch("src.ui.views.auth_page.determine_user_next_page") as mock_determine, patch(
            "time.sleep"
        ) as mock_sleep:
            mock_determine.return_value = "dashboard"
    ...
    def test_show_auth_page_register(self, mock_register, mock_radio, mock_columns, mock_markdown, mock_session_state):
...
class TestDashboardPage:
    ...
    def test_show_dashboard_page_success(
        self, mock_metric, mock_columns, mock_markdown, mock_title, mock_get_campaigns, mock_require_auth
    ):
        ...
        with patch("streamlit.session_state", mock_session_state), patch("streamlit.divider") as mock_divider, patch(
            "streamlit.button"
        ) as mock_button:
    ...
    def test_show_dashboard_page_campaigns_error(self, mock_error, mock_title, mock_get_campaigns, mock_require_auth):
        ...
        with patch("streamlit.session_state", mock_session_state), patch("streamlit.markdown"), patch(
            "streamlit.columns", side_effect=mock_columns_side_effect
        ), patch("streamlit.metric"), patch("streamlit.divider"), patch("streamlit.button"):
            show_dashboard_page()
    ...
    @patch("streamlit.rerun")
    def test_show_dashboard_page_new_campaign_button(self, mock_rerun, mock_button, mock_get_campaigns, mock_require_auth):
        ...
        with patch("streamlit.session_state", mock_session_state), patch("streamlit.title"), patch(
            "streamlit.markdown"
        ), patch("streamlit.columns", side_effect=mock_columns_side_effect), patch("streamlit.metric"), patch(
            "streamlit.divider"
        ):
            show_dashboard_page()
...
class TestSettingsPage:
    ...
    @patch("streamlit.columns")
    @patch("streamlit.button")
    def test_show_settings_page_success(self, mock_button, mock_columns, mock_title, mock_get_campaigns, mock_require_auth):
        ...
        with patch("streamlit.session_state", mock_session_state), patch("streamlit.divider"), patch(
            "streamlit.markdown"
        ), patch("streamlit.info"), patch("streamlit.metric"):
            show_settings_page()
    ...
    def test_show_settings_page_back_button(self, mock_rerun, mock_button, mock_get_campaigns, mock_require_auth):
        ...
        with patch("streamlit.session_state", mock_session_state), patch("streamlit.title"), patch(
            "streamlit.columns", side_effect=mock_columns_side_effect
        ), patch("streamlit.divider"), patch("streamlit.markdown"), patch("streamlit.warning"), patch("streamlit.metric"):
            show_settings_page()
...
class TestPerformancePage:
    ...
    def test_show_performance_page_success(self, mock_button, mock_show_performance, mock_require_auth):
        ...
        with patch("streamlit.session_state", mock_session_state), patch("streamlit.divider"):
            show_performance_page()
