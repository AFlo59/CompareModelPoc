...
class TestSystemMonitoringAdditional:
    def test_get_disk_stats_permission_error(self):
        ...
        with patch.object(sm.psutil, "disk_partitions", return_value=[Part()]), patch.object(
            sm.psutil, "disk_usage", side_effect=PermissionError
        ):
    ...
    def test_show_system_monitoring_refresh_and_auto(self, mock_st):
        ...
        with patch(
            "src.analytics.system_monitoring.get_system_info",
            return_value={
                "os": "X",
                "os_version": "1",
                "architecture": "x64",
                ...
                "cpu_count": 1,
                "cpu_count_logical": 2,
                "boot_time": __import__("datetime").datetime.now(),
            },
        ), patch(
            ...
            "src.analytics.system_monitoring.get_memory_stats",
            return_value={
                "memory_total": 1,
                "memory_available": 1,
                "memory_used": 0,
            ...
            "src.analytics.system_monitoring.get_disk_stats", return_value=[]
        ), patch(
            "src.analytics.system_monitoring.get_network_stats",
            return_value={
                "bytes_recv": 0,
                "packets_recv": 0,
                "errin": 0,
            ...
            "src.analytics.system_monitoring.get_streamlit_process_info",
            return_value={
                "pid": 1,
                "memory_info": type("mi", (), {"rss": 0, "vms": 0})(),
                "cpu_percent": 0.0,
